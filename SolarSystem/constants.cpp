...
double Rmercury = 0.39;         // [AU]
double Rvenus = 0.72;           // [AU]
double Rmars = 1.52;            // [AU]
double Rearth = 1.0;            // [AU]
double Rjupiter = 5.2;          // [AU]
double Rsaturn = 9.54;          // [AU]
double Ruranus = 19.19;         // [AU]
double Rneptun = 30.06;         // [AU]
